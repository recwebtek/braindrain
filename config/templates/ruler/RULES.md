...
| `prime_workspace(path=".", agents=None, dry_run=False, sync_templates=False, all_agents=False, local_only=True, bundle="core")` | Prime project; auto-detects IDE, applies bundle manifest, writes `.braindrain/primed.json` |
