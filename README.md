...
| `run_workflow(name, args)`                               | Execute a workflow. Intermediate output is routed through the sandbox — only the final summary returns to the agent. Supports `async_mode=true` with polling via `get_task_status(task_id)`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| `get_task_status(task_id)`                               | Poll status/result for async long-running MCP tasks (`run_workflow`, `run_dream`, `prime_workspace`).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
...
- `workflow_engine.use_model_tiers` — when true, `run_workflow` attempts model-tier summarization using configured `models.tier_*` before falling back to deterministic sandbox summaries
